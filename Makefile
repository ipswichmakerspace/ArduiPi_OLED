...
# Make the library
ArduiPi_OLED: ArduiPi_OLED.o Adafruit_GFX.o bcm2835v2.o Wrapper.o
...
install: 
	...
	@cp -f  bcm2835v2.h $(PREFIX)/include
...
uninstall: 
	...
	@rm -rf  $(PREFIX)/include/bcm2835v2.h
